pro doppler_color, gamma=gamma, redvector=redvector, greenvector=greenvector, bluevector=bluevector, blackFirst=blackFirst, whiteEnd=whiteEnd
;+
; NAME:
;   DOPPLER_COLOR
;
...
if keyword_set(whiteEnd) then whiteEnd=1B else whiteEnd=0B
steps = 128
