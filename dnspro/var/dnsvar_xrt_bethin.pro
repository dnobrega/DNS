PRO dnsvar_bethin, d, name, snaps, swap, var, units, $
                    var_title=var_title, var_range=var_range, var_log=var_log, $
                    info=info
  IF KEYWORD_SET(info) THEN BEGIN
     message, 'XRT Be-thin response',/info
     RETURN
  ENDIF ELSE BEGIN
     IF n_params() LT 6 THEN BEGIN
        message,'dnsvar_bethin, d, name, snaps, swap, var, units, ' $
     ...
     tresp = alog10((xrt_tresp.temp)[0:25,4])
     xresp = (xrt_tresp.temp_resp)[0:25,4]
