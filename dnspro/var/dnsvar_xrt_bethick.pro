PRO dnsvar_xrt_bethick, d, name, snaps, swap, var, units, $
                   var_title=var_title, var_range=var_range, var_log=var_log, $
                   info=info
  IF KEYWORD_SET(info) THEN BEGIN
     message, 'XRT-bethick response with ne dependence and Asplund 2021 coronal abundance',/info
     RETURN
  ENDIF ELSE BEGIN
     IF n_params() LT 6 THEN BEGIN
        message,'dnsvar_xrt_be-thick, d, name, snaps, swap, var, units, ' $
     ...
     RESTORE, folder+"xrt_be-thick_response_ne_tg.sav"
