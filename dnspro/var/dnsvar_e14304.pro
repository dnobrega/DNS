PRO dnsvar_e14304, d, name, snaps, swap, var, units, $
    var_title=var_title, var_range=var_range, var_log=var_log, $
    info=info
    IF KEYWORD_SET(info) THEN BEGIN
       message, 'Emissivity of Si X 14304.719',/info
       RETURN
    ENDIF ELSE BEGIN
       IF n_params() LT 6 THEN BEGIN
          message,'dnsvar_e14304, d, name, snaps, swap, var, units, ' $
       ...
       ch_synthetic,14304,14305,output=ion, sngl_ion='si_10', dens=1e9, /goft ,radtemp=6000, rphot=1.025, /photons
       ...
       var_title='!4e!3 Si X 14304 (phot cm!u-3!n s!u-1!n arcsec!u-2!n)'
       var_range=[1d-8,5d-7]
       var_log=1
    ENDELSE
END
