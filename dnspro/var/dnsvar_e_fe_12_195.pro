PRO dnsvar_e_fe_12_195, d, name, snaps, swap, var, units, $ 
    var_title=var_title, var_range=var_range, var_log=var_log, $
    info=info
    IF KEYWORD_SET(info) THEN BEGIN
       message, 'Emissivity of Fe XII 195',/info
       RETURN
    ENDIF ELSE BEGIN
       IF n_params() LT 6 THEN BEGIN
          message,'dnsvar_e_fe_12_195, d, name, snaps, swap, var, units, ' $
       ...
       RESTORE, folder+"goft_table_fe_12_195.1190.sav"
       ...
       var_title='!4e!3 Fe XII 195 (erg cm!u-3!n sr!u-1!n s!u-1!n)'
       var_range=[1d-8,5d-7]
       var_log=1
    ENDELSE
END
