PRO dnsvar_e10749_xlos_pcorona, d, name, snaps, swap, var, units, $
                   var_title=var_title, var_range=var_range, var_log=var_log, $
                   info=info

  IF KEYWORD_SET(info) THEN BEGIN
     message, 'Emissivity XLOS from PCORONA for Fe XIII 10749',/info
     RETURN
  ENDIF ELSE BEGIN
     IF n_params() LT 6 THEN BEGIN
        message,'dnsvar_e10749_xlos_pcorona, d, name, snaps, swap, var, units, ' $
