PRO dnsvar_e_fe_14_264, d, name, snaps, swap, var, units, $
    var_title=var_title, var_range=var_range, var_log=var_log, $
    info=info
    IF KEYWORD_SET(info) THEN BEGIN
       message, 'Emissivity of Fe XIV 264.788',/info
       RETURN
    ENDIF ELSE BEGIN
       IF n_params() LT 6 THEN BEGIN
          message,'dnsvar_e_fe_14_264, d, name, snaps, swap, var, units, ' $
       ...
       RESTORE, folder+"goft_table_fe_14_264.788.sav"
