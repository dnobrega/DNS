PRO dnsvar_e108, d, name, snaps, swap, var, units, $
    ...
    ENDIF ELSE BEGIN
       IF n_params() LT 6 THEN BEGIN
          message,'dnsvar_e284, d, name, snaps, swap, var, units, ' $
       ...
       ch_synthetic, 108.052, 108.056, density=1e9,/goft,SNGL_ION="fe_19",output=ion
