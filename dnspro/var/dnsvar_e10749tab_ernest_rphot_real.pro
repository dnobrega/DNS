PRO dnsvar_e10749tab_ernest_rphot_real, d, name, snaps, swap, var, units, $
    var_title=var_title, var_range=var_range, var_log=var_log, $
    info=info
    IF KEYWORD_SET(info) THEN BEGIN
       message, 'Emissivity of Fe XIII 10749',/info
       RETURN
    ENDIF ELSE BEGIN
       ...
       RESTORE, folder+"goft_table_fe_13_10749.50_rphot_6108.28.sav"
