PRO dnsvar_e5695tab_ernest_rphot, d, name, snaps, swap, var, units, $
    var_title=var_title, var_range=var_range, var_log=var_log, $
    info=info
    IF KEYWORD_SET(info) THEN BEGIN
       message, 'Emissivity of Ca XV 5695',/info
       RETURN
    ENDIF ELSE BEGIN
       IF n_params() LT 6 THEN BEGIN
          message,'dnsvar_e5695, d, name, snaps, swap, var, units, ' $
       ...
       RESTORE, folder+"goft_table_ca_15_5695.085_rphot_6000.sav"
       ...
       var_title='!4e!3 Ca XV 5695 (phot cm!u-3!n s!u-1!n arcsec!u-2!n)'
       var_range=[1d-8,5d-7]
       var_log=1
    ENDELSE
END
