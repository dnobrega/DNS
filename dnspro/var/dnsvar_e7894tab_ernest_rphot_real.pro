PRO dnsvar_e7894tab_ernest_rphot_real, d, name, snaps, swap, var, units, $
    var_title=var_title, var_range=var_range, var_log=var_log, $
    info=info
    IF KEYWORD_SET(info) THEN BEGIN
       message, 'Emissivity of Fe XI 7894',/info
       RETURN
    ENDIF ELSE BEGIN
       ...
       RESTORE, folder+"goft_table_fe_11_7894.031_rphot_6063.61.sav"
