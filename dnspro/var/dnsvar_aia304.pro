PRO dnsvar_aia304, d, name, snaps, swap, var, units, $
                   var_title=var_title, var_range=var_range, var_log=var_log, $
                   info=info
  IF KEYWORD_SET(info) THEN BEGIN
     message, 'AIA 304 response with ne dependence and Asplund 2021 coronal abundance',/info
     RETURN
  ENDIF ELSE BEGIN
     IF n_params() LT 6 THEN BEGIN
        message,'dnsvar_aia304, d, name, snaps, swap, var, units, ' $
     ...
     RESTORE, folder+"aia_304_response_ne_tg.sav"
