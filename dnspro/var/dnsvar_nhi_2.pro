PRO dnsvar_nhi_2, d, name, snaps, swap, var, units, $
    ...
    ENDIF ELSE BEGIN 
       IF n_params() LT 6 THEN BEGIN
          message,'dnsvar_nhi, d, name, snaps, swap, var, units, ' $
       ...
       ratio    = var(wh)/((-(n1_n0(wh) + 1.0d) + sqrt((n1_n0(wh) + 1.0d)^2.0d + 8.0d*nht(wh)/n02_nh2))/(4.0d/n02_nh2))
       var(wh)  = (-(n1_n0(wh) + 1.0d) + sqrt((n1_n0(wh) + 1.0d)^2.0d + 8.0d*nht(wh)/n02_nh2))/(4.0d/n02_nh2)
