PRO dnsvar_e_fe_16_335, d, name, snaps, swap, var, units, $ 
    ...
    ENDIF ELSE BEGIN
       IF n_params() LT 6 THEN BEGIN
          message,'dnsvar_e_fe_16_335, d, name, snaps, swap, var, units, ' $
       ...
       RESTORE, folder+"goft_table_fe_16_335.4090.sav"
       ...
       var_title='!4e!3 Fe XVI 335 (erg cm!u-3!n sr!u-1!n s!u-1!n)'
       var_range=[1d-8,5d-7]
       var_log=1
    ENDELSE
END
