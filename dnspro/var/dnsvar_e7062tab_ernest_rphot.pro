PRO dnsvar_e7062tab_ernest_rphot, d, name, snaps, swap, var, units, $
    var_title=var_title, var_range=var_range, var_log=var_log, $
    info=info
    IF KEYWORD_SET(info) THEN BEGIN
       message, 'Emissivity of Fe XV 7062',/info
       RETURN
    ENDIF ELSE BEGIN
       IF n_params() LT 6 THEN BEGIN
          message,'dnsvar_e7062, d, name, snaps, swap, var, units, ' $
       ...
       RESTORE, folder+"goft_table_fe_15_7062.147_rphot_6000.sav"
       ...
       var_title='!4e!3 Fe XV 7062 (phot cm!u-3!n s!u-1!n arcsec!u-2!n)'
       var_range=[1d-8,5d-7]
       var_log=1
    ENDELSE
END
